...
function initSlideShow() {
	$('div.n-banner-wrapper').fadeGallery({
		slides: 'a.n-banner>.n-slade',
	...
	$('a.n2-banner-wrapper').fadeGallery({
		slides: 'span.n2-banner>.n2-slade',
		switchSimultaneously: true,
		disableWhileAnimating: true,
		switchTime: 3000,
		autoRotation: true,
	...
	$('a.so-banner-smile').fadeGallery({
		slides: '.so-banner-smile-item',
		switchSimultaneously: true,
		switchTime: 3000,
		autoRotation: true,
		disableWhileAnimating: true,
	...
	$('a.sk-banner').fadeGallery({
		slides: '.sk-banner__item',
		switchSimultaneously: true,
		switchTime: 2200,
		autoRotation: true,
		disableWhileAnimating: true,
